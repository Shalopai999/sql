...
select distinct mark, (select count(*) from auto auto1 
where auto1.mark != auto2.mark) as "Количество машин других марок" from auto auto2;

-- 3. Даны 2 таблицы, созданные следующим образом:

create table test_a (idnumber int, data varchar(1));
create table test_b (idnumber int);
insert into test_a(idnumber, data) values
(10, 'A'),
(20, 'A'),
(30, 'F'),
(40, 'D'),
(50, 'C');
insert into test_b(idnumber) values
(10),
(30),
(50);
...
select * from test_a natural left join test_b 
where test_b.idnumber is null;